...
public interface BlockEntityRenderHandler {
     ...
     */
    <T extends class_2586> void addRenderPredicate(class_2591<T> type, BlockEntityRenderPredicate<T> shouldRender);
     ...
     */
    <T extends class_2586> boolean removeRenderPredicate(class_2591<T> type, BlockEntityRenderPredicate<T> shouldRender);
}
