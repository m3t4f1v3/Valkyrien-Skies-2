...
public interface VertexBufferWriter {
    /**
     * Converts a {@link class_4588} into a {@link VertexBufferWriter}.
     *
    ...
    /**
     * Converts a {@link class_4588} into a {@link VertexBufferWriter} if possible.
     *
     * @param consumer The vertex consumer to create a writer for
    ...
    /**
     * If this {@link VertexBufferWriter} passes through data to nested {@link class_4588} implementations,
    ...
    static void copyInto(VertexBufferWriter writer,
                         ...
                         class_293 format)
    {
        var length = count * format.method_1362();
