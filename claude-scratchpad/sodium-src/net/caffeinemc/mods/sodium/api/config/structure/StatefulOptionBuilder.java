...
public interface StatefulOptionBuilder<V> extends OptionBuilder {
    @Override
    StatefulOptionBuilder<V> setName(class_2561 name);

    @Override
    OptionBuilder setEnabled(boolean available);

    @Override
    OptionBuilder setEnabledProvider(Function<ConfigState, Boolean> provider, class_2960... dependencies);
    ...
    @Override
    StatefulOptionBuilder<V> setTooltip(class_2561 tooltip);
     ...
     * @return The current builder instance.
     */
    StatefulOptionBuilder<V> setTooltip(Function<V, class_2561> tooltip);
    ...
    /**
     * Sets flags for this option using {@link class_2960} instances.
     *
     * @param flags The flags as identifiers.
     * @return The current builder instance.
     */
    StatefulOptionBuilder<V> setFlags(class_2960... flags);
     ...
     * @return The current builder instance.
     */
    StatefulOptionBuilder<V> setDefaultProvider(Function<ConfigState, V> provider, class_2960... dependencies);
