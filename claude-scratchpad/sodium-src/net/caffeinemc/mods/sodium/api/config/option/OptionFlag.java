...
public enum OptionFlag {
    ...
    private final class_2960 id = class_2960.method_60655("sodium", "builtin_option_flag." + this.name().toLowerCase(Locale.ROOT));

    /**
     * Gets the {@link class_2960} for this option flag.
