...
public interface ModOptionsBuilder {
     ...
     * @return The current builder instance.
     */
    ModOptionsBuilder setIcon(class_2960 texture);

    /**
     * Sets the icon texture for the mod. Same as {@link #setIcon(class_2960)}, but the texture will be rendered in its original color instead of being tinted.
     *
     * @param texture The ID of the icon texture.
     * @return The current builder instance.
     */
    ModOptionsBuilder setNonTintedIcon(class_2960 texture);
     ...
     * @return The current builder instance.
     */
    ModOptionsBuilder registerOptionReplacement(class_2960 target, OptionBuilder replacement);
     ...
     * @return The current builder instance.
     */
    ModOptionsBuilder registerOptionOverlay(class_2960 target, OptionBuilder overlay);
     ...
     * @return The current builder instance.
     */
    ModOptionsBuilder registerFlagHook(BiConsumer<Collection<class_2960>, ConfigState> hook, class_2960... triggers);

    /**
     * Registers a hook just like {@link #registerFlagHook(BiConsumer, class_2960...)}, but using a {@link FlagHook}.
     *
